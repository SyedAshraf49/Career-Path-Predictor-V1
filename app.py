...
try:
    ...
    encoders = joblib.load("models/sklearn_encoders.pkl")
    print("✅ Models loaded successfully")
except FileNotFoundError as e:
    print(f"❌ Error loading models: {e}")
    print("⚠️  Please run 'python generate_datasets.py' first")
    print("⚠️  Then run 'python model_enhanced.py' to train the model")
    model = None
    scaler = None
    encoders = None
